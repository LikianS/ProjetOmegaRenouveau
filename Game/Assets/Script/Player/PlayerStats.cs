...
public class PlayerStats : MonoBehaviour
{
    ...
    private void InitializeWeapons()
    {
        ...
        availableWeapons.Add(new WeaponStats("�p�e", 40, 0.15f, 1f, 0.25f, 2f, 80, 0.35f, 1.5f, 0.5f));
    ...
    public void EquipWeapon(WeaponStats weapon)
    {
        ...
        Debug.Log($"Arme �quip�e : {weapon.weaponName}");
        UpdatePlayerStatsUI();
        GameManager.Instance.SaveGame();
    }
    ...
    private void ResolveUiManager()
    {
        ...
        if (uiManager == null)
        {
            Debug.LogError("uiManager n'est pas assign� dans PlayerStats et aucun HealthStaminaUI trouv� dans la sc�ne !");
        }
    }
